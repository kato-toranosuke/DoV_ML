...
def createCsv(filename: str = 'features_ch0.csv') -> None:
    ...
    with open(OUTPUT_PATH + filename, 'w') as f:
        ...
        header_feature_vals = ['low_power', 'high_power', 'hlbr', 'ratio_max_to_10ms_ave_peaks', 'ratio_max_to_9th_ave_peaks', 'ac_std', 'ac_auc', 'diff_std', 'diff_auc', 'srmr']
        ...
        # 特徴量を計算
        ff_gen = ff.FetchFeaturesFromDataset2(DATASET_PATH)
        for rows in ff_gen:
