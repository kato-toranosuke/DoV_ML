...
def createCsv(filename: str, output_path: str = OUTPUT_PATH, dataset_path: str = DATASET_PATH) -> None:
    '''
    CSVを作成する関数
    ...
    output_path : str, default OUTPUT_PATH
        CSVファイルの出力先のディレクトリへのパス
    dataset_path : str, default DATASET_PATH
        データセットへのパス
...
def createCsvGp(filename: str, output_path=OUTPUT_PATH, dataset_path=DATASET_PATH) -> None:
    '''
